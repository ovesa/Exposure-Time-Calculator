...
input_filter = 'jc_V'#input('Filter Options:\n'+filter_list+'\nFilter: ')
    # filter efficiency
...
moonphase = '0'#input('Moon-Sun Angle Options:\n'+moonphase_list+'\nMoon Phase: ')
...
# get photon flux
phot_flux = calcPhotFlux('Vega', input_phot_band, input_magnitude)
print('phot_flux: ', phot_flux)

# GetSprime(lambda_vals, phot_flux, atm_e, tel_e, inst_e, filt_e, det_e)
S_prime = GetSprime(.1, phot_flux, atmos_transmission, 1.0, inst_eff, filter_eff, 1.0) # tel_e = 1.0, det_e = 1.0
print('Sprime is: ', S_prime*Tel_Collect_Area)

# GetSprime(lambda_vals, phot_flux, atm_e, tel_e, inst_e, filt_e, det_e)
B_prime = GetSprime(.1, 0, atmos_transmission, 1.0, inst_eff, filter_eff, 1.0) # tel_e = 1.0, det_e = 1.0
...
#took val at center and mult by bandpass?
#Raw input is func of wavelength
#seeing the plot for spec
#adding in table showing expt at every (~however many angstroms)
#dummy background spectrum (3.63*10**-21?)
#
